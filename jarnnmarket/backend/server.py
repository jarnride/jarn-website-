from fastapi import FastAPI, APIRouter, HTTPException, Depends, Request, UploadFile, File, Query, Body
...
NIGERIABULKSMS_USERNAME = os.environ.get('NIGERIABULKSMS_USERNAME', '')
NIGERIABULKSMS_PASSWORD = os.environ.get('NIGERIABULKSMS_PASSWORD', '')
...
SMS_MOCK_MODE = not NIGERIABULKSMS_USERNAME or not NIGERIABULKSMS_PASSWORD
